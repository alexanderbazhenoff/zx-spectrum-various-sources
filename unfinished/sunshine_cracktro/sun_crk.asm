...
TXTLINES_COL    EQU #18
ATRLIN_BUF1     EQU FONT_ADR+#600
ATRLIN_BUF2     EQU ATRLIN_BUF1+#20 ;+#20 only (set/res bit5!)
TXTLIN_BUF      EQU #5B00
...
;-------copy text and attributes to linebuffer------
        ...
        ;in:  HL=text_addr
        ;     [#od] - enter
        ;     [#o1...o6] - normal colour /look NORMAL/
        ;     [#o7] - allow colour /look ALLOW/
        ;out: HL=next_addr
...
TRAINER_TEXT
        DB 6,".fuckin trainer.бля.fuckin trainer.."          ;00
        DB 6,"                                    "         ;01
