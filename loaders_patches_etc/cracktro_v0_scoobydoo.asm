...
CHETPR2 DEFB #16,21,29,#10,7,#11,0,#13,1
...
TXT
        ...
        DEFB "E L I T E   S O F T W A R E  '86"
        DEFB #0D,#0D
        DEFB "SCOOBY DOO IN THE CASTLE MYSTERY"
        DEFB #0D,#0D
        DEFB "STUFF:%$%-$$-%$-%$$%%$-$%%%$%-%$"
        ...
        DEFB "GREETZ:$%$%-$%-%$%%$-%$$%%%$-%$%"
        DEFB  #0D,#0D,#0D
        DEFB "$%$$BRAINWAVE TRAINER (+#02)%$%%"
        DEFB #0D,#0D
        DEFB "1.UNLIMIT LIVES..............NOP"
        DEFB "2.INVENCIBLE.................NOP"
        DEFB #0D,#0D
...
ATRTEXT DEFB 10,#43,#2,#45,10,#47,43,#43
        ...
        DEFB 96,#47
        DEFB #6,#45,26,#43
        DEFB 13,#44,#7,#47,#5,#46,#7,#47  ;STUFF LIST
